...
import { ArrowLeft, Bookmark, ChevronRight, Download, ExternalLink, Eye, Heart, Instagram, Languages, Link2, LoaderCircle, Share2, Smartphone, Volume2 } from "lucide-react";
...
export default function NameDetailPage() {
  ...
  const [imageAction, setImageAction] = useState<SocialFormat | null>(null);
